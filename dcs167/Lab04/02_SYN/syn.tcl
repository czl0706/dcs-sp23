...
#  Output Reports 
#======================================================
report_timing >  Report/Seq\.timing
report_area >  Report/Seq\.area
report_resource >  Report/Seq\.resource
...
write -format verilog -output Netlist/Seq\_SYN.v -hierarchy

write_sdf -version 3.0 -context verilog -load_delay cell Netlist/Seq\_SYN.sdf -significant_digits 6
