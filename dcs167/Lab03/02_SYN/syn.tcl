...
report_resource >  Report/Counter\.resource
...
write -format verilog -output Netlist/Counter\_SYN.v -hierarchy

write_sdf -version 3.0 -context verilog -load_delay cell Netlist/Counter\_SYN.sdf -significant_digits 6
