...
write -format verilog -output Netlist/Conv\_SYN.v -hierarchy

write_sdf -version 3.0 -context verilog -load_delay cell Netlist/Conv\_SYN.sdf -significant_digits 6
